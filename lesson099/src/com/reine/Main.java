...
/**
 * 每个单元格节点使用使用setUserData() 保存数据，需要加载数据时使用getUserData() 再进行相应的类型转换
 * @author reine
 * 2022/6/6 11:04
 */
public class Main extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        ageCol.setCellFactory(new Callback<TableColumn<StudentProperty, Integer>, TableCell<StudentProperty, Integer>>() {
            ...
            public TableCell<StudentProperty, Integer> call(TableColumn<StudentProperty, Integer> param) {
                return new TableCell<StudentProperty, Integer>() {
                    ...
                    public void startEdit() {
                        super.startEdit();
                        Spinner<Integer> spinner = new Spinner<>(0, 100, Integer.parseInt(this.getUserData().toString()));
            ...
            public TableCell<StudentProperty, Boolean> call(TableColumn<StudentProperty, Boolean> param) {
                return new TableCell<StudentProperty, Boolean>() {
                    ...
                    public void startEdit() {
                        ...
                        comboBox.setPromptText(Boolean.parseBoolean(this.getUserData().toString()) ? "男" : "女");
                    ...
                    private void initGraphic() {
                        Label label = new Label(Boolean.parseBoolean(this.getUserData().toString()) ? "男" : "女");
                        this.setGraphic(label);
                    }
                };
            }
        ...
        primaryStage.setTitle("TableView自定义单元格编辑，使用setUserData");
